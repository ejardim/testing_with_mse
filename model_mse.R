...
# hack to have the same target as type 2
# attach("model/fsquared.rda")
# ftrg <- ftrg + c(args(control(tune, "hcr"))$target - iterMedians(ftrg))
# detach("file:model/fsquared.rda")
